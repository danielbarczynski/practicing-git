...
git merge [branch-name]  => merges two branches, push needed after this (no changes in history). it also adds all commits to the branch history (so it can get messy sometimes)  
